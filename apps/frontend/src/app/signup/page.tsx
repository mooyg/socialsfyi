    ...
    <div className="flex h-screen items-center justify-center">
      <div className="bg-secondary-background border-button-background flex w-[300px] flex-col space-x-2 rounded-3xl border p-8 ">
        <div className="mb-2 flex">
          ...
          <h2 className="text-button-background text-2xl font-bold">.UP</h2>
        </div>
        <Form.Root onSubmit={signUpUser} className="space-y-8">
          ...
          <Form.Field name="username">
            <div className="flex items-baseline justify-between">
              <Form.Label className="text-sm font-bold">Username</Form.Label>
            </div>
            <Form.Control asChild>
              <input
          ...
          {error ? (
            <div className="flex rounded-xl border border-red-700 bg-red-700 bg-opacity-10 p-2 text-xs font-bold">
              Some Error Occured
            </div>
          ) : null}
        </Form.Root>
